...
struct BootloaderConfig {
    physical_memory_offset: Option<usize>,
    kernel_stack_address: Option<usize>,
    kernel_stack_size: Option<usize>,
}

#[cfg(feature = "binary")]
fn parse_aligned_addr(key: &str, value: &str) -> usize {
        ...
        match (key.as_str(), value.clone()) {
            ...
            ("kernel-stack-size", Value::Integer(i)) => {
                if i <= 0 {
                    ...
                    cfg.kernel_stack_size = Some(i as usize);
                }
            }
            (s, _) => {
                panic!(
