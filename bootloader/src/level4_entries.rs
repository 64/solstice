...
impl UsedLevel4Entries {
    pub fn new(segments: &FixedVec<ProgramHeader64>) -> Self {
        ...
        for segment in segments {
            let start_page: Page = Page::containing_address(VirtAddr::new(segment.virtual_addr as usize));
            let end_page: Page =
                Page::containing_address(VirtAddr::new((segment.virtual_addr + segment.mem_size) as usize));
